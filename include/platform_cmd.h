...
/*@param max        当也返回的最大数量                                   */
typedef int32_t(*t_ont_cmd_dev_query_files)(void *dev, int32_t channel, int32_t startindex, int32_t max, ont_video_file_t **files, int32_t *filenum, int32_t *totalnum);
